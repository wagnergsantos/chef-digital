                ...
                >
                    ...
                    <div style={{
                        ...
                        <div className={styles.modalHeaderTools} style={{ display: 'flex', alignItems: 'center', gap: '8px', flexShrink: 0 }}>
                            ...
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" aria-hidden="true">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 100-5.367 3 3 0 000 5.367zm0 8a3 3 0 100-5.367 3 3 0 000 5.367z"></path>
                                </svg>
                            </button>
                            <a
                                href={`admin.html?edit=${recipe.id}`}
                                className={styles.modalShareBtn}
                                title="Editar receita no Painel Admin"
                                aria-label="Editar receita no Painel Admin"
                                data-print-hide
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" aria-hidden="true">
